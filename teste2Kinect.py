...
while 1:
	...
	rcircles = cv2.HoughCircles(rclosing,cv.CV_HOUGH_GRADIENT,2,mindist,param1=60,param2=30,minRadius=minRadius,maxRadius=0)
	verificaR=0;
	...
	ycircles = cv2.HoughCircles(yclosing,cv.CV_HOUGH_GRADIENT,2,mindist,param1=60,param2=30,minRadius=minRadius,maxRadius=0)
	verificaY=0;
	...
	bcircles = cv2.HoughCircles(bclosing,cv.CV_HOUGH_GRADIENT,2,mindist,param1=60,param2=30,minRadius=minRadius,maxRadius=0)
	verificaB=0;
